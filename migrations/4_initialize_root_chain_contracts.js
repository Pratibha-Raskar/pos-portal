...
*/
  ...
  const roott = contractAddresses.root.DummyERC20
  console.log('root',roott)
  const childt = contractAddresses.child.DummyERC20
  console.log('child',childt)
  console.log('type',ERC20Type)
